...
public class Test03 {
    ...
    private static WordParseHelper wordParseHelper = new WordParseHelper();
    ...
    public static Model getModel(List<String> item) {
    ...
    public static void insertOne(Model model, MongoCollection<Document> dbSheet) {
        //一条文档中的字段信息和相对应的数据
     ...
     * 查询集合中所有数据
     */
    public static boolean queryOne(String TCode, MongoCollection<Document> dbSheet) {
        //筛选条件对象
    ...
    public static Model readPdf(Model model) {
